...
control groups, $s_T^2$ and $s_C^2$ are the sample standard deviation of
treatment and control groups, and $J \approx 1 - \frac{3}{(4\; (n_T + n_G) - 9}$
is the correction factor,
with $n_T$ and $n_G$ being the sample size of treatment and control groups.
